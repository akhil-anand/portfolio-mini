...
const Portfolio = () => {
  return (
    ...
    <Project img = {resumeBuilder} name= "Resume Builder"  gitHub="" hostingLink="https://resume-builder-79633.web.app/" title="A MERN stack application which uses mongo db for database and google auth for authentication" tags={["ReactJs", "Material UI", "memories", ]}/>
    <Project img = {ticTacToe} name= "TicTacToe App"  gitHub="" hostingLink="https://tiktactoe-48014.web.app/" title="Tic Tac Toe application" tags={["Angular", "Nebular"]}/>
