...
import profile from "../images/coder1.jpeg";
...
function Card()
{
    return(
        <div className="w-full">
            ...
            <div className="">
                <img className="w-64 mx-auto shadow-xl rounded-full drop-shadow-sm" src={profile} alt="profile photo"/>
            </div>
            <div className="text-center mt-5">
                <p className="text-xl sm:text-2xl text-gray-900"> Akhil</p>
                ...
                <a className="text-xl m-1 p-1 sm:m-2 sm:p-2 text-blue-700 hover:bg-blue-600 rounded-full hover:text-white transition-colors duration-300" href="https://github.com/akhil-anand">
                <AiFillLinkedin/>
